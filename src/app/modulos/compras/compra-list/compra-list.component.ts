...
const DATA: ComprasList[] = [
  {id: 1, num_cotizacion: "C0001", tipo_comprobante:"boleta",
  ...
  {id: 2, num_cotizacion: "C0002", tipo_comprobante:"factura",
...
export class CompraListComponent implements OnInit {
  ...
  //CABECERA
  displayedColumns: string[] = ['select', 'id', 'num_cotizacion', 'tipo_comprobante', 'fec_emision', 'num_serie' ,'num_comprobante','ruc_dni', 'razon_name', 'moneda','val_venta', 'IGV', 'monto_tot'];
  dataSource = new MatTableDataSource<ComprasList>(DATA);
  selection = new SelectionModel<ComprasList>(true, []);
  ...
  checkboxLabel(row?: ComprasList): string {
    if (!row) {
